...
const subPages = [
  {
    ...
    component:
      <div className="flex flex-col justify-center items-center">
        ...
        <ResumeGrid>
          {/* FusionHive Backend Intern */}
          <ResumeCard>
            <div className="flex justify-between items-center mb-2">
              <h3 className="font-bold text-xl">Backend Engineer Intern</h3>
              <span className="text-sm text-muted-foreground pl-2 text-right">Jan 2026 – Present</span>
            </div>
            <h4 className="text-[var(--color-accent)] font-medium mb-3">FusionHive (Alps Insurance)</h4>
            <ul className="list-disc pl-5 space-y-2 text-sm">
              <li>Building backend services for a health insurance marketplace platform integrating multiple insurer APIs.</li>
              <li>Implemented workflows managing the quote → proposal → KYC → payment → policy lifecycle.</li>
              <li>Improved reliability with Redis-based token caching and normalized heterogeneous insurer API schemas.</li>
              <li>Deploying containerized services using Docker on AWS for consistent production environments.</li>
            </ul>
          </ResumeCard>
          {/* Deloitte Capstone */}
          <ResumeCard>
